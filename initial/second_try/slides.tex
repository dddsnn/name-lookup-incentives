...
\begin{frame}{Reputation Tracking}
  \begin{itemize}
    \item Peers form small groups in which they forward queries
...
\begin{frame}{Simulation}
  \begin{itemize}
    ...
    \item Observe how peers' behavior evolves and what level of service is
          achieved (query response times)
  \end{itemize}
\end{frame}
