...
\texttt{thesis/simulation\_runs/reputation\_availability} subdirectory. The file
name is given for each result (TODO).
...
\caption{Reputation over time for strategy \emph{overlap} for 2 peers}
...
\caption{Reputation percentiles over time for strategy \emph{overlap} in one
query group}
...
\caption{Response statuses over time for strategy \emph{overlap}}
...
\caption{Reputation percentiles over time for strategy \emph{overlap
$\rightarrow$ reputation saturated last} in 2 query groups}
...
\caption{Reputation over time for strategy \emph{overlap $\rightarrow$
reputation saturated last} for 2 peers}
...
\caption{Response statuses over time for strategy \emph{overlap $\rightarrow$
reputation saturated last}}
...
\caption{Reputation percentiles over time for strategy \emph{overlap
$\rightarrow$ reputation sorted} in 2 query groups}
